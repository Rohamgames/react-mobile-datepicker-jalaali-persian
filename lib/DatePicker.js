...
class DatePicker extends Component<void, Props, State> {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (date.jy !== this.state.value.jy || date.jm !== this.state.value.jm || date.jd !== this.state.value.jd) {
    ...
    componentDidUpdate() {
        ...
        // if (value.jy > max.jy) {
        //     this.setState({ value: max.jy });
        // }

        //
        // if(value.jy < min.jy || value.jm < min.jm || value.jd < min.jd) {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        return true;
        // return (date.jy === this.state.value.jy && date.jm === this.state.value.jm && date.jd === this.state.value.jd) ||
